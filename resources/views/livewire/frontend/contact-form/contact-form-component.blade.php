                ...
                <form wire:submit.prevent="submit" class="php-email-form">
                    <div class="row gy-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="name-field" wire:model="name"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="subject-field" wire:model="subject"
                                class="form-control" required>
                            @error("subject")
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                <input type="checkbox" id="data-consent" wire:model="dataConsent"
                                    class="form-check-input" required>
                                <label class="form-check-label" for="data-consent">
                                    Ich erlaube dieser Website, meine Angaben zu speichern, um auf
