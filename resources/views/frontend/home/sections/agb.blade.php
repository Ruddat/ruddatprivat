        ...
        <div class="container mt-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="card shadow-sm p-4">
                ...
                <p>
                    ...
                    <strong>Ingo Ruddat</strong> und seinen Kunden
                    abgeschlossen werden. Abweichende Bedingungen des Kunden werden nicht anerkannt, es
                    sei denn, <strong>Ingo Ruddat</strong> stimmt ihrer
                    Geltung ausdrücklich zu.
                </p>

                <h3 class="mt-4">2. Vertragsabschluss</h3>
                <p>
                    Ein Vertrag kommt erst mit der schriftlichen Bestätigung der Bestellung durch
                    <strong>Ingo Ruddat</strong> oder mit Beginn der
                ...
                <p>
                    Die Leistungen umfassen Webdesign, Webentwicklung, Beratungsleistungen sowie andere
                    individuell vereinbarte Tätigkeiten.
                </p>
                <h4 class="mt-3">3.2 Änderungen</h4>
                <p>
                    <strong>Ingo Ruddat</strong> behält sich das Recht vor, Änderungen oder Anpassungen
                    an den Leistungen vorzunehmen, soweit diese dem Kunden
                    zumutbar sind.
                </p>
                ...
                <p>
                    Die Zahlung ist spätestens 14 Tage nach Rechnungsstellung fällig. Im Falle des
                    Zahlungsverzugs behält sich <strong>Ingo Ruddat</strong> das
                    Recht vor, Verzugszinsen in gesetzlicher Höhe zu berechnen.
                </p>

                <h3 class="mt-4">5. Mitwirkungspflichten des Kunden</h3>
                <p>
                    Der Kunde verpflichtet sich, alle notwendigen Informationen und Unterlagen
                    rechtzeitig bereitzustellen, um eine ordnungsgemäße
                ...
                <p>
                    <strong>Ingo Ruddat</strong> haftet nicht für Schäden, die durch leichte
                    Fahrlässigkeit verursacht wurden, es sei denn, es handelt sich um
                    die Verletzung wesentlicher Vertragspflichten.
                </p>
                <h4 class="mt-3">6.2 Haftungshöchstbetrag</h4>
                <p>
                    Die Haftung ist auf den Auftragswert beschränkt, sofern nicht gesetzlich zwingend
                ...
                <p>
                    ...
                    innerhalb von 14 Tagen ohne Angabe von Gründen zu
                    widerrufen. Die Widerrufsfrist beginnt mit dem Tag des Vertragsabschlusses.
                </p>

                <h3 class="mt-4">8. Datenschutz</h3>
                <p>
                    <strong>Ingo Ruddat</strong> verarbeitet personenbezogene Daten des Kunden nur im
                    Rahmen der geltenden Datenschutzgesetze. Weitere
                ...
                <p>
                    Gerichtsstand ist Braunschweig, Niedersachsen, sofern der Kunde Kaufmann,
